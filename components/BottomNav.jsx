...
/**
 * Bottom Navigation Bar — Mobile-only, All Roles
 * Replaces hamburger menu on mobile for all dashboard roles.
 * Renders a thumb-friendly bottom tab bar like native apps.
 */
