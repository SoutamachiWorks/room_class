...
function DashboardLayoutInner({ children }) {
  ...
  const showDocumentationShortcut = ['admin', 'teacher', 'student'].includes(userRole);
  ...
  const buildNavHref = (href) => {
    if (userRole !== 'student' || !activeYearId) return href;
      ...
      <div className={styles.mainArea}>
        ...
        <header className={styles.topBar}>
          ...
          <div className={styles.topBarRight}>
            {showDocumentationShortcut && (
              <Link href="/dokumentasi" className={styles.helpButton}>
