      ...
      <div className={styles.contentCard}>
        ...
        <div className={styles.filterSection}>
          ...
          <div className={styles.roleTabs}>
            <button className={roleFilter === '' ? styles.tabBtnActive : styles.tabBtn} onClick={() => { setRoleFilter(''); setPage(1); }}>Semua</button>
            <button className={roleFilter === 'admin' ? styles.tabBtnActive : styles.tabBtn} onClick={() => { setRoleFilter('admin'); setPage(1); }}>Admin</button>
            <button className={roleFilter === 'teacher' ? styles.tabBtnActive : styles.tabBtn} onClick={() => { setRoleFilter('teacher'); setPage(1); }}>Guru</button>
            <button className={roleFilter === 'student' ? styles.tabBtnActive : styles.tabBtn} onClick={() => { setRoleFilter('student'); setPage(1); }}>Siswa</button>
          </div>
        </div>
